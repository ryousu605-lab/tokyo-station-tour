...
OVERRIDE = {
    ...
    "新幹線北乗り換え口西.jpg": "e",    # 実景は東向き（正面に HANAGATAYA・左手に「北口→」）
    # EXIF は 130°=東南東だが、構内図上この地点から HANAGATAYA 店舗は東北東〜北側にある
    # （東は同グループの 82° の通路写真が使う）。屋内で磁気が振れた EXIF より現地の
    # 位置関係を優先し、店舗正面のこの1枚を北に割り当てる。
    "八重洲南口周辺弁当屋.jpg": "n",
}
